...
var refreshRe, _ = regexp.Compile(`^Bearer (eyJ[a-zA-Z0-9_\-]+?\.[a-zA-Z0-9_\-]+?\.[a-zA-Z0-9_\-]+?$)`)
...
func RefreshToken(ctx iris.Context) {
	...
	utils.SendJson(ctx, RefreshTokenRes{AccessToken: accessToken, RefreshToken: refreshToken})
}
